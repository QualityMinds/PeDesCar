...
from ..utils import NoReward, CustomReward, TargetVelocityReward, PosReward, DomainRandomizationHandler
...
class LocoEnv(MultiMuJoCo):
    ...
    def __init__(self, xml_handles, action_spec, observation_spec, collision_groups=None, gamma=0.99, horizon=1000,
                 ...
                 N_worker_per_xml_dom_rand=4, seed=0, **viewer_params):
        """
        Constructor.
        ...
        """
        self.seed(seed=seed)  # Adding Seed
    ...
    def set_sim_state(self, sample):
        ...
        # assert len(sample) == len(obs_spec) # TODO: Correct a way to identify states between the car and the humanoid.
